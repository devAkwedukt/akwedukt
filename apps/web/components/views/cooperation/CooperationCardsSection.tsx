...
export default function CooperationCardsSection({ item }: { item: CooperationCardsSection }) {
  ...
  return (
    <section className="w-full px-20 py-16 2xl:py-18 bg-gray-50 flex flex-col items-center gap-14 overflow-hidden">
      ...
      <main className="max-w-480 mx-auto flex flex-row justify-start items-stretch gap-8 2xl:gap-14 flex-wrap">
