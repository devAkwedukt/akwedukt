...
export default function SupportHeroSection({ item }: SupportHeroSectionProps) {
  ...
  return (
    <section className="py-8 md:py-16 2xl:py-20 px-6 md:px-15 2xl:px-20">
      <main className="max-w-480 mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-14">
