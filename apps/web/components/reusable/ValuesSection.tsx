...
export default function ValuesSection({ item }: { item: ValuesSection }) {
  ...
  return (
    <section className="max-w-480 w-full px-6 md:px-20 3xl:px-20 py-8 md:py-16 2xl:py-20 mx-auto">
      {/* Section Title */}
      {item.title && (
      ...
      {item.values && item.values.length > 0 && (
        <main className="flex flex-col md:flex-row justify-between gap-12 2xl:gap-16">
